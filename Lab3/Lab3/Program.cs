    ...
    public class Program
    {
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                var roots = Solver.SolveQuadraticEquation(a.Item1, b.Item1, c.Item1);
        ...
        public static class Solver
        {
            public static List<double> SolveQuadraticEquation(double a, double b, double c)
            {
                ...
                {
                    double root = -b / (2 * a);
                    return new List<double> { Math.Round(root, 2), Math.Round(root, 2) };
                }
                else
                {
                    ...
                    //return new List<double> { Math.Round(root1, 2), Math.Round(root2, 2) };
                }
            }
        }
    }
